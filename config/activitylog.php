...
return [
     ...
     */
    // The causer is the currently-authenticated user on this guard. Set to
    // 'admin' because almost all auditable mutations happen in the Filament
    // admin panel (separate `admin` guard, ebc_admin table). Instructor
    // self-edits on /instructor/account use the `web` guard and will log
    // with null causer — acceptable because the subject IS the user.
