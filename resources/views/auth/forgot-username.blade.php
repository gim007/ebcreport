...
<head>
    ...
    <title>Forgot username &mdash; {{ config('app.name') }}</title>
    <style>
...
<body>
    <div class="card">
        ...
        <div class="inner">
            ...
            <p class="sub">Enter your email address. We'll send you a reminder with every username registered to that address.</p>
